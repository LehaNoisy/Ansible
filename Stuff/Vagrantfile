...
Vagrant.configure("2") do |config|
  config.vm.define "webserver" do |subconfig|
    ...
    subconfig.vm.network :private_network, ip: "10.1.1.15"
    #subconfig.vm.provision "shell" , path: "./httpd.sh" 
  end
  $NODE_COUNT = 1
  ...
  (1..$NODE_COUNT).each do |i|
    config.vm.define "appserver" do |subconfig|
      ...
      subconfig.vm.network :private_network, ip: "10.1.1.30"
      #subconfig.vm.provision "shell" , path: "./jenkins.sh", args: i
    end
  end
end
